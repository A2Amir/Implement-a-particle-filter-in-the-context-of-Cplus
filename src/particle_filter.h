...
class ParticleFilter {
 ...
 public:
   ...
   */
    ...
    */
    double MultivariateGaussian(const LandmarkObs &prediction, const LandmarkObs &observation,
                                                         double std_landmark[]);
    ...
    */
    ...
    std::vector<LandmarkObs> FindnearbyLandmarks(double x, double y, double range, std::vector<Map::single_landmark_s> landmarks);
